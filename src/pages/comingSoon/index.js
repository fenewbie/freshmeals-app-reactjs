...
export default function ComingSoon() {
	return (
		<div className="bg-coming-soon bg-cover bg-center bg-no-repeat  px-4 py-24 md:h-screen md:overflow-y-scroll">
			<div className=" flex flex-col items-center justify-center">
				...
				<div className="mt-14 mb-10  shrink lg:w-2/4 md:w-2/3 w-full mx-auto">
				...
				<Link
					to="/contact"
					className="btn-animated uppercase text-white mb-10"
				>
