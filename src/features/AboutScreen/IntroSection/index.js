			...
			<div className="grid lg:grid-cols-2 grid-cols-1 gap-16">
				...
				<div>
					...
					<p className="border-l-2 border-greenBtn px-8 py-1 relative lg:-top-4 -top-8">
						We provide happiness by producing a fresh food
						experience for people of all ages.
					</p>
					<p className="lg:mt-6">
						Diversifying the products and services offered to
						customers has seen the introduction of dairy ranges, dry
						stores, in-house fruit and vegetable preparation, high
						quality meats, and chef-designed ready-to-eat menu
						products. All ready-to-eat options are designed and
						prepared using the very best ingredients and are
						hand-crafted by a team of experts with the FreshMeals.
					</p>
