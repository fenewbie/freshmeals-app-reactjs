...
export default function BtnIconItem({
	...
	return (
		<div className="absolute left-0 top-1/2 w-full text-center opacity-0 invisible transition-all duration-300 translate-y-1/2 group-hover:opacity-100 group-hover:-translate-y-1/2 group-hover:visible">
			<button
