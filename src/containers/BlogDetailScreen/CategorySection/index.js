	...
	return (
		<CommonSection title="Categories">
			{categories.map((category) => (
				<Button className=" group text-white py-2 px-6 mb-4 w-full bg-[#071C1F] hover:bg-greenBtn flex justify-between items-center transition-all duration-300 rounded-md">
